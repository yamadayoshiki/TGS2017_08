...
public:
	...
	static bool Segment_Segment(const GSvector2& pos1, const GSmatrix4& mat1, const float & length1, const GSvector2& pos2, const GSmatrix4& mat2, const float & length2);
