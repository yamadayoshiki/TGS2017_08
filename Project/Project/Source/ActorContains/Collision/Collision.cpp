...
bool Collision::Segment_Segment(const GSvector2 p1[], const GSvector2 p2[]){
	...
	return false; //Segment_Segment_MinLength_Square(p1_start, p1_end, p2_start, p2_end) < 0;
}

// 線分同士の衝突判定
bool Collision::Segment_Segment(const GSvector2 & pos1, const GSmatrix4 & mat1, const float & length1, const GSvector2 & pos2, const GSmatrix4 & mat2, const float & length2){
	//Vector3 p1[2], p2[2];
	...
	return false; // Segment_Segment(p1, p2);
}
