...
void GameManager::LoadContent() {
	...
	p_Renderer2D->LoadTexture("ChargeButtonOse", "Resource/Texture/UI/Tutorial/gaido_mokuhyou1.png");
	p_Renderer2D->LoadTexture("YButtonOse", "Resource/Texture/UI/Tutorial/gaido_mokuhyou2.png");
	...
	//EnemySE
	gsLoadSE(SE_ENEMY_CHILDAPPEARED, "Resource/Sound/SE/Enemy/子機出現.wav", 10, GWAVE_DEFAULT);
	gsLoadSE(SE_ENEMY_ENEMYEXPLOTION, "Resource/Sound/SE/Enemy/敵爆発.wav", 10, GWAVE_DEFAULT);
	gsLoadSE(SE_ENEMY_GENERATESINGING, "Resource/Sound/SE/Enemy/親機詠唱.wav", 10, GWAVE_DEFAULT);
	gsLoadSE(SE_ENEMY_RUSH, "Resource/Sound/SE/Enemy/突っ込む時.wav", 10, GWAVE_DEFAULT);
	gsLoadSE(SE_ENEMY_SHOT, "Resource/Sound/SE/Enemy/弾を発射.wav", 10, GWAVE_DEFAULT);
	gsLoadSE(SE_ENEMY_SPINBOUND, "Resource/Sound/SE/Enemy/壁に当たって跳ね返る.wav", 10, GWAVE_DEFAULT);
